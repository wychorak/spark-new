...
check(appSource.includes('userIntents: intents') && appSource.includes('sharedIntentCount') && appSource.includes('targetIntents') && appSource.includes('rotationScore'), 'Multi-intent discovery ranking or filtering is missing.');
